...
**This app deliberately doesn't do background GPS.** Users tap "I'm here" manually. We test the _content_ and _recommendation_ layer; native phase tests the _automation_ layer.
